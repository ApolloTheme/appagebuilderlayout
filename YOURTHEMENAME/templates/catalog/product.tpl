...
{block name='content'}
  ...
  {assign var="productLayout" value={hook h="pagebuilderConfig" configName="productLayout"}}
  {if $productLayout == 'rdas.tpl'}
    {include file='./products/rdas.tpl'}
  {else if $productLayout == 'mech_mods.tpl'}
    {include file='./products/mech_mods.tpl'}
  {else if $productLayout == 'product-moder.tpl'}
    {include file='./products/product-moder.tpl'}
  {else}
    <!-- New -->
