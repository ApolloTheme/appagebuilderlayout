  ...
  <!-- New -->
  <section id="main" class="product-default product-mechmods" itemscope itemtype="https://schema.org/Product">
    <meta itemprop="url" content="{$product.url}">

      <div class="row">
          <div class="hidden-lg-up col-lg-6 col-md-12">
          ...
          <div class="detail-content col-lg-6 col-md-12">
